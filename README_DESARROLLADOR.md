# Minutas ASH 2.3.3 — Guía breve del desarrollador

La arquitectura separa GUI, workflow, modelos, repositorios, documentos y proveedores. La versión 2.3.3 agrega:
...
Consulte `docs/Manual_Programador_2.3.3.md` y `docs/PROCESAMIENTO_RESILIENTE_2.3.3.md`.

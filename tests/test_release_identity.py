...
class ReleaseIdentityTests(unittest.TestCase):
    def test_second_generation_identity(self):
        self.assertEqual(APP_VERSION, "2.3.7")
        self.assertEqual(RELEASE_SEQUENCE, 2003006)
    ...
    def test_windows_resources_and_installer_match_release(self):
        ...
        self.assertIn('#define MyAppVersion "2.3.7"', installer)
        self.assertIn("MinutasASH_Setup_2.3.7_Online", installer)

...
class ReleaseIdentityTests(unittest.TestCase):
    def test_second_generation_identity(self):
        self.assertEqual(APP_VERSION, "2.3.3")
        self.assertEqual(RELEASE_SEQUENCE, 2003003)
    ...
    def test_windows_resources_and_installer_match_release(self):
        ...
        self.assertIn("filevers=(2, 3, 3, 0)", version_info)
        self.assertIn("prodvers=(2, 3, 3, 0)", version_info)
        self.assertIn("FileVersion', '2.3.3'", version_info)
        self.assertIn('#define MyAppVersion "2.3.3"', installer)
        self.assertIn("MinutasASH_Setup_2.3.3_Online", installer)

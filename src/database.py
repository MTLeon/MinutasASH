...
from src.catalog_models import (
    AuditEvent, ClientRecord, ContactRecord, OrganizationRecord,
    ProjectCatalogRecord, TemplateManifest, TemplateValidation, TemplateVersionRecord,
)
    ...
    def upsert_organization(self, record: OrganizationRecord | dict) -> int:
        ...
        with self.connect() as db:
            if item.id:
                ...
                result = int(row[0] if row else cursor.lastrowid)

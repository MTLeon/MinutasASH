...
TOPICS = {
    "maestro": ("Manual maestro", "Manual_Maestro_2.3.4.md"),
    "usuario": ("Manual de usuario", "Manual_Usuario_2.3.4.md"),
    "configuracion": ("Manual de instalación y configuración", "Manual_Configuracion_2.3.4.md"),
    "procesamiento": ("Reuniones extensas y recuperación", "PROCESAMIENTO_RESILIENTE_2.3.4.md"),
    "productividad": ("Revisión masiva y ventanas", "QOL_REVISION_VENTANAS_2.3.4.md"),
    "programador": ("Guía del programador y depuración", "Manual_Programador_2.3.4.md"),
}
